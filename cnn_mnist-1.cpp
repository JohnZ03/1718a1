...
double sigmoid(double x) {
  ...
  if(x>-5.66&&x<=-5.41)   y = 0.0040;
  if(x>-6&&x<=-5.66)      y = 0.0030;
  if(x>-6.53&&x<=-6)      y = 0.0020;
  if(x>-7.6&&x<=-6.53)    y = 0.0010;
  if(x<=-7.6)             y = 0;
  if(x>1&&x<=2)           y = -0.0467*x*x + 0.2896*x + 0.4882;
  if(x>2&&x<=3)           y = -0.0298*x*x + 0.2202*x + 0.5600;
  if(x>3&&x<=4)           y = -0.0135*x*x + 0.1239*x + 0.7030;
  if(x>4&&x<=5)           y = -0.0054*x*x + 0.0597*x + 0.8297;
