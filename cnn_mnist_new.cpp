...
/* ************************************************************ */
/* Forward Pass */
void forward_pass(unsigned char img[][34]) {
...
/* ************************************************************ */
/* Backward Pass */
void backward_pass(double *y_hat, int *y, unsigned char img[][34]) {
        double delta4[10];
        for (int i=0; i<10; i++) {
...
void give_img(unsigned char* vec , unsigned char img[][34]) {
        int k=0;
        for (int i=0; i<34; i++) {
                for (int j=0; j<34; j++) {
                        if (i<3 || j<3 || i>30 || j>30) {
                                img[i][j] = 0;
                        } else {
                                img[i][j] = vec[k++];
                        }
